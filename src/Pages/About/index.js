    ...
    return (
        <div className='about-container'>
            ...
            <div className="about-header-container">
                ...
                <p>Our big-picture hope is for every pet in Australia to be safe, respected and loved - whether the pet is owned, surrendered to a shelter, unclaimed at the pound, seized by authorities, or trapped by rangers.</p>
            </div>
            ...
            <div className='about-blocks-container'>
                ...
                <div className='block-container' id='reverse'>
                    ...
                    <div className='block-text'>
                        ...
                        <p>We are digital innovators, always looking for ways we can leverage the latest advances in the tech world to solve the big issues and challenges that rescue pets face in Australia.</p>
                    </div>
                </div>
                <div className='block-container'>
