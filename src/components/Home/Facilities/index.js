            ...
            <div className='facilities-content'>
                ...
                <div className='wrapper'>
                    ...
                    <li>Публікація анкет тварин на нашому вебсайті</li>
                         ...
                         <li>Пошук ідеального улюбленця для вас</li>
                     ...
                     <ul className='column'>
                         ...
                         <li>Тренінги та посібники з догляду</li>
                         ...
                         <h3>Наш вебсайт може бути корисним для обох сторін - людей, які хочуть знайти домашнього улюбленця для себе і для людей, які хочуть знайти нову сім'ю для свого улюбленця.</h3>
                    </ul>
                </div>
            </div>
        </div>
